...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.phone_confirmed'
        db.delete_column(u'accounts_userprofile', 'phone_confirmed')

        # Adding field 'UserProfile.phone_verified'
        db.add_column(u'accounts_userprofile', 'phone_verified',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.phone_confirmed'
        db.add_column(u'accounts_userprofile', 'phone_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.phone_verified'
        db.delete_column(u'accounts_userprofile', 'phone_verified')
