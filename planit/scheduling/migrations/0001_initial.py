...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scheduling_meeting', (
            ...
            ('set_time', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='set_time', null=True, to=orm['scheduling.SuggestedTime'])),
        ...
        db.create_table(u'scheduling_suggestedtime', (
            ...
            ('set_as_time', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
