...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Meeting.set_time' to match new field type.
        db.rename_column(u'scheduling_meeting', 'set_time', 'set_time_id')
        # Changing field 'Meeting.set_time'
        db.alter_column(u'scheduling_meeting', 'set_time_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['scheduling.SuggestedTime']))
        # Adding index on 'Meeting', fields ['set_time']
        db.create_index(u'scheduling_meeting', ['set_time_id'])

        # Adding field 'SuggestedTime.set_as_time'
        db.add_column(u'scheduling_suggestedtime', 'set_as_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'Meeting', fields ['set_time']
        db.delete_index(u'scheduling_meeting', ['set_time_id'])


        # Renaming column for 'Meeting.set_time' to match new field type.
        db.rename_column(u'scheduling_meeting', 'set_time_id', 'set_time')
        # Changing field 'Meeting.set_time'
        db.alter_column(u'scheduling_meeting', 'set_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'SuggestedTime.set_as_time'
        db.delete_column(u'scheduling_suggestedtime', 'set_as_time')
    ...
    models = {
        ...
        u'scheduling.meeting': {
            ...
            'set_time': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'set_time'", 'null': 'True', 'to': u"orm['scheduling.SuggestedTime']"}),
        ...
        u'scheduling.suggestedtime': {
            ...
            'set_as_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
